                  ...
                  <section className="glass-card border border-sky-500/10 p-5 sm:p-6">
                    ...
                    <div className="space-y-3">
                      {waitlistEntries.map((entry) => {
                        ...
                        const branch = branches.find((item) => item.id === entry.branch_id);
                            ...
                            <div className="flex flex-wrap items-start justify-between gap-3">
                              <div>
                                <p className="text-sm font-semibold text-white">
                                  {service?.name ?? "Servicio en espera"}
                                </p>
                        ...
                        <div className="flex flex-col gap-5 md:flex-row md:items-center">
                          ...
                          <div className="flex-1 min-w-0 space-y-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              <span className={`inline-flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-xs font-medium ${attendance.tone} bg-white/5`}>
                                <span className="h-1.5 w-1.5 rounded-full bg-current" />
                                {attendance.label}
                              </span>
                              {item.release_reason && (
                          ...
                          <div className="flex shrink-0 items-center justify-between gap-3 border-t border-white/5 pt-3 md:flex-col md:justify-center md:items-end md:border-t-0 md:pt-0">
